...
class Tomato:
    states = {0: 'семена', 1: 'росток', 2: 'зеленый помидор', 3: 'красный помидор'}
...
class Gardener:
    ...
    def knowledge_base():
        print('''
        10 самых важных советов по выращиванию томатов
...
Мульчируйте почву после ее разогрева ...
Отрывайте старые листья у высоких растений''')
